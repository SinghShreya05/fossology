  ...
  public function getTableForSingleType($type, $description, $uploadId, $uploadTreeId, $filter, $agentId)
  {
    ...
    $output = "<h4>Activated $typeDescriptor statements:</h4>
               ...
               <div class='form-group'>
                 <label class='control-label col-sm-2'>Advance search:</label>
                 <span class='col-sm-7'>
		   <input type='text' class='form-control advSearch' id='advSearchText".$type."'>
                 </span>
                 <span class='col-sm-1'>
                   <img src='images/info_16.png' title='Use \"(*)\" to match any thing.\nExample: \"Copyright (*) All rights reserved(*)\" will match \"Copyright 2012-2020 Company ABC. All rights reserved {and some garbage here}\"' alt='' class='info-bullet'>
                 </span>
                 <span class='col-sm-2'>
                   <button type='button' class='btn btn-default btn-sm' onClick='createReplacementText(\"".$type."\")' title='Create a replacement text with all placeholders.'>Create replacement text</button>
                 </span>
               </div>
               <br/><br/>
               <div class='form-group'>
                 ...
                 <span class='col-sm-3'>
                   <img src='images/info_16.png' title='Use \"$1 $2\" as placeholder for corresponding (*) values.\nExample: \"Copyright $1 All rights reserved\" will result in \"Copyright 2012-2020 Company ABC. All rights reserved\" from example above' alt='' class='info-bullet'>
                 </span>
                 <br/><br/>
                 <button style='margin-left:15px;' class='btn btn-default btn-sm' id='testReplacement".$type."'>Test replacement</button>
                 <button style='margin-left:15px;' class='btn btn-default btn-sm' id='replaceSelected".$type."'>Replace selected rows</button>
                 <button style='margin-left:15px;' class='btn btn-default btn-sm' id='deleteSelected".$type."'>Deactivate selected rows</button>
               </div>
               <div class='form-group'>
                 <br/><br/>
                 <table border=1 id='testVal".$type."' style='display:none' width='100%' class='dataTable'>
               ...
               <div>
                 <table border=1 width='100%' id='copyright".$type."deactivated'></table>
                 <br/><br/>
                 <button style='margin-left:15px;' class='btn btn-default btn-sm' id='undoSelected".$type."'>Undo selected rows</button>
               </div>";
